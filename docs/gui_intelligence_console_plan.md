...
- current endpoints implemented: `GET /api/overview`, `GET /api/watches`, `POST /api/watches`, `POST /api/watches/{id}/run`, `POST /api/watches/{id}/disable`, `POST /api/watches/run-due`, `GET /api/alerts`, `GET /api/alert-routes`, `GET /api/watch-status`
